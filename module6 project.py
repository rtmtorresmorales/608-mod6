 ...
 "cells": [
  {
   ...
   "outputs": [],
   "source": [
    "# Module 6 Project: Dta Files and SQL , Ramon Torres 9/23/2022"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Using matplotlib backend: <object object at 0x00000249217591E0>\n"
     ]
    }
   ],
   "source": [
